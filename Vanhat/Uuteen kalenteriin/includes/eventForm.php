    ...
    <form id="submiteventform" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
        ...
        <p><label for="datestart"><?php echo $label_dates; ?></label><br>
            ...
            <span>
                ...
                <input placeholder="<?php echo $date_placeholder; ?>" type="text" id="datestart" name="datestart" onfocus="checkRadioButton('date_datepicker');" value="<?php echo $datestart; ?>"> - <input type="text" id="dateend" name="dateend" value="<?php echo $dateend; ?>"> 
            </span><span class="error"><?php echo $dateErr; ?></span><br>
            <input type="radio" name="dateselect" id="date_text" onchange="dateButtons();" value="2" />
            <input placeholder="<?php echo $datetext_placeholder; ?>" type="text" id="datetext" name = "datetext" onfocus="checkRadioButton('date_text');" value="<?php echo $datetext; ?>">
        </p>
